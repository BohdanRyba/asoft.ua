...
<div data-active-color="purple-love" data-background-color="purple-love" data-image="" class="app-sidebar">
    <!-- main menu header-->
    <!-- Sidebar Header starts-->
    <div class="sidebar-header">
        <div class="logo clearfix"><a href="{{route('dashboard')}}" class="logo-text float-left">
                <div class="logo-img"><img src="../app-assets/img/logo-dark.png"/></div>
    ...
    <div class="sidebar-content">
        <div class="nav-container">
            <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
                <li class=" nav-item"><a href="{{route('dashboard')}}"><i class="ft-home"></i><span data-i18n=""
                                                                                                    class="menu-title">Dashboard</span></a>
                </li>
                <li class="has-sub nav-item"><a href="#"><i class="ft-edit"></i><span data-i18n="" class="menu-title">User Data</span></a>
                    <ul class="menu-content">
                        <li class="has-sub"><a href="#" class="menu-item">ACL</a>
                            <ul class="menu-content">
                                <li><a href="{{route('roles.index')}}" class="menu-item">Roles</a>
                                </li>
                                <li><a href="input-groups.html" class="menu-item">Permissions</a>
                                </li>
                            </ul>
                        </li>
                ...
                <li class="has-sub nav-item"><a href="#"><i class="ft-bar-chart-2"></i><span data-i18n=""
                ...
                <li class=" nav-item"><a href="calendar.html"><i class="ft-calendar"></i><span data-i18n=""
                ...
                <li class=" nav-item"><a
                        href="https://pixinvent.com/apex-angular-4-bootstrap-admin-template/documentation"><i
                            class="ft-book"></i><span data-i18n="" class="menu-title">Documentation</span></a>
                </li>
...
{{--style="background-image: url('http://asoft.ua/app-assets/img/sidebar-bg/03.jpg');">--}}
