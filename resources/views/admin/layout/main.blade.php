...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('js/admin/vendors/css/perfect-scrollbar.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('js/admin/vendors/css/prism.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('js/admin/vendors/css/chartist.min.css')}}">
    <!-- END VENDOR CSS-->
    <!-- BEGIN APEX CSS-->
    <link rel="stylesheet" type="text/css" href="{{asset('css/admin/app.min.css')}}">
    <!-- END APEX CSS-->
...
<div class="wrapper">
    ...
    <div data-active-color="black" data-background-color="purple-love" data-image="{{asset('img/admin/sidebar-bg/01.jpg')}}" class="app-sidebar">
        <!-- main menu header-->
        <!-- Sidebar Header starts-->
        <div class="sidebar-header">
            <div class="logo clearfix"><a href="index.html" class="logo-text float-left">
                    <div class="logo-img"><img src="{{asset('img/admin/logo-dark.png')}}"/></div><span class="text align-middle">APEX</span></a><a id="sidebarToggle" href="javascript:;" class="nav-toggle d-none d-sm-none d-md-none d-lg-block"><i data-toggle="expanded" class="ft-toggle-right toggle-icon"></i></a><a id="sidebarClose" href="javascript:;" class="nav-close d-block d-md-block d-lg-none d-xl-none"><i class="ft-x"></i></a></div>
        </div>
        <!-- Sidebar Header Ends-->
        <!-- / main menu header-->
        <!-- main menu content-->
...
<div class="customizer border-left-blue-grey border-left-lighten-4 d-none d-sm-none d-md-block"><a class="customizer-close"><i class="ft-x font-medium-3"></i></a><a id="rtl-icon" href="https://pixinvent.com/apex-angular-4-bootstrap-admin-template/html-demo-6/" target="_blank" class="bg-dark customizer-toggle"><span class="font-medium-1 white align-middle">RTL</span></a><a id="customizer-toggle-icon" class="customizer-toggle bg-danger"><i class="ft-settings font-medium-4 fa fa-spin white align-middle"></i></a>
    <div data-ps-id="df6a5ce4-a175-9172-4402-dabd98fc9c0a" class="customizer-content p-3 ps-container ps-theme-dark">
        ...
        <div class="cz-bg-image row">
            <div class="col mb-3"><img src="{{asset('img/admin/sidebar-bg/01.jpg')}}" width="90" class="rounded"></div>
            <div class="col mb-3"><img src="{{asset('img/admin/sidebar-bg/02.jpg')}}" width="90" class="rounded"></div>
            <div class="col mb-3"><img src="{{asset('img/admin/sidebar-bg/03.jpg')}}" width="90" class="rounded"></div>
            <div class="col mb-3"><img src="{{asset('img/admin/sidebar-bg/04.jpg')}}" width="90" class="rounded"></div>
            <div class="col mb-3"><img src="{{asset('img/admin/sidebar-bg/05.jpg')}}" width="90" class="rounded"></div>
            <div class="col mb-3"><img src="{{asset('img/admin/sidebar-bg/06.jpg')}}" width="90" class="rounded"></div>
        </div>
...
<!-- BEGIN VENDOR JS-->
<script src="{{asset('js/admin/vendors/js/core/jquery-3.2.1.min.js')}}" type="text/javascript"></script>
<script src="{{asset('js/admin/vendors/js/core/popper.min.js')}}" type="text/javascript"></script>
<script src="{{asset('js/admin/vendors/js/core/bootstrap.min.js')}}" type="text/javascript"></script>
<script src="{{asset('js/admin/vendors/js/perfect-scrollbar.jquery.min.js')}}" type="text/javascript"></script>
<script src="{{asset('js/admin/vendors/js/prism.min.js')}}" type="text/javascript"></script>
<script src="{{asset('js/admin/vendors/js/jquery.matchHeight-min.js')}}" type="text/javascript"></script>
<script src="{{asset('js/admin/vendors/js/screenfull.min.js')}}" type="text/javascript"></script>
<script src="{{asset('js/admin/vendors/js/pace/pace.min.js')}}" type="text/javascript"></script>
<!-- BEGIN VENDOR JS-->
<!-- BEGIN PAGE VENDOR JS-->
<script src="{{asset('js/admin/vendors/js/chartist.min.js')}}" type="text/javascript"></script>
<!-- END PAGE VENDOR JS-->
<!-- BEGIN APEX JS-->
<script src="{{asset('js/admin/app-sidebar.min.js')}}" type="text/javascript"></script>
<script src="{{asset('js/admin/notification-sidebar.min.js')}}" type="text/javascript"></script>
<script src="{{asset('js/admin/customizer.min.js')}}" type="text/javascript"></script>
<!-- END APEX JS-->
<!-- BEGIN PAGE LEVEL JS-->
<script src="{{asset('js/admin/dashboard1.min.js')}}" type="text/javascript"></script>
<!-- END PAGE LEVEL JS-->
</body>
</html>
